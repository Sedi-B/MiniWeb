...
const Contact = () => {
	...
	mr-[55px] mt-10 rounded-lg '>
		...
		text-green-900'>
			...
			outline-none border-2 p-2 border-gray-100
			...
			border-2 p-2 border-gray-100 rounded-md focus:ring
			...
			border-2 p-2 border-gray-100 rounded-md h-[105px]
			focus:ring focus:border-green-800 ' id="text" >
					...
					<button
            className="flex items-center justify-center border-green-500 text text-xl 
